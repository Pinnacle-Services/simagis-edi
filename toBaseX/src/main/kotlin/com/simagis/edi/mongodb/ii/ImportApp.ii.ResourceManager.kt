...
/**
 * <p>
 * Created by alexei.vylegzhanin@gmail.com on 1/4/2018.
 */
...
internal class ImportFileCommand(file: IIFile) : SessionCommand {
...
internal class CommandSuccess(val doc: Document) : CommandResult()
internal abstract class CommandError(val error: Document) : CommandResult()
...
internal class ResourceManager(sharedMemory: Long = 16.gb) : Closeable {
